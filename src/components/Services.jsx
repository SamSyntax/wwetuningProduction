...
function Services() {
  ...
  return (
    <ScrollTrigger className='flex flex-col justify-between' onEnter={() => setCounterOn(true)} onExit={() => setCounterOn(false)}>
      <div className='flex justify-center items-center w-screen lg:my-2 sm:my-[16rem] '>
        <div className='w-full h-[200px] md:h-[400px] lg:h-[200px]  bg-black/20 lg:flex lg:justify-around backdrop-blur-3xl grid grid-cols-2 grid-rows-2 justify-center items-center '>
          <img className='md:scale-50 scale-sm' src={volkswagen} alt='' />
          <img className='md:scale-50 scale-sm' src={bmw} alt='' />
          <img className='md:scale-50 scale-sm' src={mercedes} alt='' />
          <img className='md:scale-50 scale-sm' src={audi} alt='' />
        </div>
      </div>
      <div
        id='Services'
        className='h-screen w-screen grid md:grid-cols-2 md:grid-rows-2 sm:grid-cols-1 sm:grid-rows-2  px-12 lg:px-24 gap-12  text-zinc-200'
      >
        ...
        <div className='flex flex-col justify-center lg:text-7xl'>
          <div className='flex items-center gap-8 md:justify-start '>
            <BsClipboard2Check className='md:w-[80px] md:h-[80px] md:block hidden' />
          ...
          <br />
          <div className='flex items-center gap-8 md:justify-start'>
            <BsEvFront className='md:w-[80px] md:h-[80px] md:block hidden' />
            <h1 className='text-4xl font-semibold text-zinc-200'>
